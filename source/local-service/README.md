...
当前用户说明以[完整使用说明](packaging/使用说明.txt)和[仓库 README](../../README.md)为准；本次为 R10，发布标签 `2008.2.7-linli.2`，程序版本 `2008.2.7`。[下载与更新说明](https://github.com/coderscsy/linli/releases/tag/2008.2.7-linli.2)。
